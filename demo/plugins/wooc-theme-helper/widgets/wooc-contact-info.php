...
// Adds widget: Wooc- Contact Info

class Wooc_Contact_Info_Widget extends WP_Widget {
		function __construct() {
			parent::__construct(
				'wooctheme_contactinfo_widget',
				esc_html__( 'Wooc- Contact Info', 'wooctheme-theme-helper' ),
				array( 'description' => esc_html__( 'Wooc - Contact Info', 'wooctheme-theme-helper' ), ) // Args
			);
		...
		<?php
			...
			<div class="contact-info">			
				...
				if( !empty( $instance['phone1'] ) ){
					?>
				<a href="tel:tel:<?php echo esc_attr( $instance['phone1'] ); ?>"><span class="flaticon-phone"></span><?php echo esc_html( $instance['phone1'] ); ?></a>
				<?php } ?>

				<?php 
				if( !empty( $instance['email1'] ) ){ ?>
					 <a href="mailto:<?php echo esc_html( $instance['email1'] ); ?>"><span class="flaticon-envelope-1"></span><?php echo esc_html( $instance['email1'] ); ?></a>
				<?php
				}					
				?>			
			</div>
...
function register_wooctheme_contactinfo_widget() {
	register_widget( 'Wooc_Contact_Info_Widget' );
}
add_action( 'widgets_init', 'register_wooctheme_contactinfo_widget' );
