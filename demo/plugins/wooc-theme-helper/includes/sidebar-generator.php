...
class sidebar_generator
{
    ...
    {
        add_action('init', array('sidebar_generator', 'init'), 1);
    ...
    public static function admin_page()
    {
        ...
        <div class="wrap">
            <h2><?php esc_html_e('Sidebar Generator', 'wooctheme-theme-helper'); ?></h2>
            <p><?php esc_html_e('The sidebar name is for your use only. It will not be visible to any of your visitors. A CSS class is assigned to each of your sidebar, use this styling to customize the sidebars.', 'wooctheme-theme-helper'); ?></p>
            <br/>
            <div class="add_sidebar">
                <a class="button button-primary button-large" href="javascript:void(0);"
                   onclick="return add_sidebar_link()"
                   title="Add a sidebar"><?php esc_html_e('+ Add Sidebar', 'wooctheme-theme-helper') ?></a>
            </div>
            <br/>
            <table class="widefat page" id="sbg_table" style="width:600px;">
                <tr>
                    <th><?php esc_html_e('Name', 'wooctheme-theme-helper'); ?></th>
                    <th><?php esc_html_e('CSS class', 'wooctheme-theme-helper'); ?></th>
                    <th><?php esc_html_e('Remove', 'wooctheme-theme-helper'); ?></th>
                </tr>
                <?php
                $sidebars = sidebar_generator::get_sidebars();
                ...
                if (is_array($sidebars) && !empty($sidebars)) {
                    ...
                    foreach ($sidebars as $sidebar) {
                        ...
                        <tr class="<?php print esc_attr($alt) ?>">
                            ...
                            <td><a class="button-secondary button" href="javascript:void(0);"
                                   onclick="return remove_sidebar_link('<?php print esc_js($sidebar); ?>',<?php print esc_js($cnt + 1); ?>);"
                                   title="<?php esc_attr_e('Remove this sidebar', 'wooctheme-theme-helper') ?>"><?php esc_html_e('remove', 'wooctheme-theme-helper'); ?></a>
                            </td>
                        </tr>
                        <?php
                        $cnt++;
                    ...
                    ?>
                    <tr>
                        <td colspan="3"><?php esc_html_e('No Sidebars defined', 'wooctheme-theme-helper'); ?></td>
                    </tr>
                    <?php
                }
                ?>
