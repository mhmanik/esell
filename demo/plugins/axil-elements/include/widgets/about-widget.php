...
if( !class_exists('esell_Info_Widget') ){
    class esell_Info_Widget extends WP_Widget{
    	/**
        ...
        function __construct(){
            ...
            $widget_options = array(
                'description'                   => esc_html__('esell: Info here', 'esell'),
                'customize_selective_refresh'   => true,
            );

            parent:: __construct('esell_Info_Widget', esc_html__( 'esell: Info', 'esell'), $widget_options );
                ...
                <div class="address">
                    ...
                    <?php endif ?>
                        <?php if (!empty($address)): ?>
                            <p><span><?php esc_html_e('A.', 'esell'); ?></span> <span class="address-info"><?php echo wp_kses_post($address); ?></span></p>
                        <?php endif ?>
                        <?php if (!empty($email)): ?>
                            <p><span><?php esc_html_e('E.', 'esell'); ?></span> <span class="address-info"><a href="mailto:<?php echo esc_html($email); ?>"><?php echo esc_html($email); ?></a></span></p>
                        <?php endif ?>
                        <?php if (!empty($phone)):
                            $number = trim( preg_replace( '/[^\d|\+]/', '', $phone ) );
                            ?>
                            <p><span><?php esc_html_e('T.', 'esell'); ?></span> <span class="address-info"><a href="tel:<?php echo esc_attr($number); ?>"><?php echo esc_html($phone); ?></a></span></p>
                        <?php endif ?>
                </div>
            </div>
        	<?php
        ...
        public function form($instance){ 
        	...
        	?>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php echo esc_html__('Title:' ,'esell') ?></label>
			...
			<div class="image_box_wrap" style="margin:20px 0 15px 0; width: 100%;">
				<button class="button button-primary author_info_image">
					<?php esc_html_e('Upload Logo', 'esell'); ?>
				</button>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('content')); ?>"><?php echo esc_html__('Content:' ,'esell') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php echo esc_html__('Address:' ,'esell') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php echo esc_html__('Email:' ,'esell') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php echo esc_html__('Phone:' ,'esell') ?></label>
...
function esell_Info_Widget(){
    register_widget('esell_Info_Widget');
}
add_action('widgets_init','esell_Info_Widget');