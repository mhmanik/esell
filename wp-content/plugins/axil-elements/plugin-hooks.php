...
class esell_elements_Plugin_Hooks
{
    ...
    {
        $this->wooc_fix_layerslider_tgm_compability(); // Fix issue of Layerslider update via TGM
    }

    public function wooc_fix_layerslider_tgm_compability()
    {
        if (!is_admin() || !apply_filters('axiltheme_disable_layerslider_autoupdate', true) || get_option('layerslider-authorized-site')) return;
...
esell_elements_Plugin_Hooks::instance();