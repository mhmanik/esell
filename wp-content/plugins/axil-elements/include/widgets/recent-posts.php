 ...
 * @package esell
 */
if( !class_exists('esell_Recent_Post') ){
    class esell_Recent_Post extends WP_Widget{
        /**
        ...
        function __construct(){
            ...
            $widget_options = array(
                'description'                   => esc_html__('esell: Recent post here', 'esell'),
                'customize_selective_refresh'   => true,
            );

            parent:: __construct('esell_Recent_Post', esc_html__( 'esell: Recent Post', 'esell'), $widget_options );
        ...
        $title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'Recent Posts','esell' );
                ...
                <div class="content-blog post-list-view mb--20">
                   <?php if ( has_post_thumbnail()): ?>
                        <div class="post-thumbnail thumbnail">
                            <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'axil-blog-thumb' ); ?></a>
                        </div>
                    <?php endif ?>                    
                    <div class="content">
    ...
    ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_item' )); ?>"><?php echo esc_html__( 'No. of Item of posts to show:','esell' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'num_title_word' )); ?>"><?php echo esc_html__( 'Title Word','esell' ); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>"><?php echo esc_html__( 'Display post date?','esell' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_read_time' )); ?>"><?php echo esc_html__( 'Display Read Time?','esell' ); ?></label>
        </p>
    <?php
        }
    }
...
function esell_Recent_Post(){
    register_widget('esell_Recent_Post');
}
add_action('widgets_init','esell_Recent_Post');
