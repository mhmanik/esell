					...
					<div class="woocue-item elementwidth elwidth-300">
						<div class="woocue-thumb-area">
							<?php if ( has_post_thumbnail() ): ?>
								<a class="woocue-thumb esell-scale-animation" href="<?php the_permalink(); ?>"><?php the_post_thumbnail( $thumb_size ); ?></a>
							<?php else: ?>
								<a class="woocue-thumb esell-scale-animation" href="<?php the_permalink(); ?>"><img src="<?php echo Helper::get_img( 'nothumb-size3.jpg' );?>"></a>
							<?php endif; ?>
							<div class="woocue-date"><div class="woocue-d1"><?php the_time( 'd' ); ?></div><div class="woocue-d2"><?php the_time( 'M' ); ?></div></div>
						</div>
