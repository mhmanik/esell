...
if ($backups->is_disabled()) {
	...
	$confirm = esc_html__(
		'IMPORTANT: Installing this demo will delete all existing data and contents of your website, so use it only in fresh website. Do you want to continue?', 'fw' //@umart-update
	);
}
?>
...
<?php echo apply_filters( 'wooc_demo_installer_warning_info', '' );//@umart-update ?>
