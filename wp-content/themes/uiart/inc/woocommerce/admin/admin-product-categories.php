...
class WOOC_Product_Categories {
    ...
    function add_fields() {
        ...
        <div class="form-field wooc-term-title-wrap">
            <label for="wooc_categories_description"><?php esc_html_e( 'Categories Grid Title', 'uiart' ); ?></label>
            <input type="text" id="wooc-categories-description" name="wooc_categories_description" value="" size="40">
            <p><?php esc_html_e( 'Enter a custom title to display in the "Product Categories" element.','uiart' ); ?></p>
        </div>
        <?php
        ...
        <div class="form-field wooc-cat-menu-thumbnail-wrap">
			<label><?php esc_html_e( 'Menu Thumbnail', 'uiart' ); ?></label>
			...
			<script type="text/javascript">
				...
				jQuery(document).on('click', '.wooc-upload_image_button', function(event) {
					...
					file_frame = wp.media.frames.downloadable_file = wp.media({
						...
						button: {
							text: '<?php esc_html_e( 'Use image', 'uiart' ); ?>'
						},
						multiple: false
					});
    ...
    function edit_fields( $term ) {
        ...
        <tr class="form-field wooc-term-title-wrap">
            <th scope="row"><label for="wooc_categories_description"><?php esc_html_e( 'Categories Grid Title', 'uiart' ); ?></label></th>
            <td>
                ...
                <p class="description"><?php esc_html_e( 'Enter a custom title to display in the "Product Categories" element.','uiart' ); ?></p>
            </td>
        </tr>
        <?php
        ...
        <tr class="form-field wooc-cat-menu-thumbnail-wrap">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Menu Thumbnail', 'uiart' ); ?></label></th>
			<td>
