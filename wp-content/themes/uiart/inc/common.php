...
$typo_body = WOOCTheme::$options['typo_body'];
$typo_h1 = WOOCTheme::$options['typo_h1'];
$typo_h2 = WOOCTheme::$options['typo_h2'];
$typo_h3 = WOOCTheme::$options['typo_h3'];
$typo_h4 = WOOCTheme::$options['typo_h4'];
$typo_h5 = WOOCTheme::$options['typo_h5'];
$typo_h6 = WOOCTheme::$options['typo_h6'];
?>
body,p {
