...
?>
    <?php get_header(); ?>
    <div id="primary" class="content-area site-index home">
        <div class="container">
            <div class="row">
                ...
                <div class="<?php Helper::the_layout_class(); ?>">
                    <div id="main-content" class="main-content">
                        <?php if (have_posts()) : ?>
                            <?php
                            if ((is_home() || is_archive()) && WOOCTheme::$options['blog_style'] == '2') {
                                ...
                                endwhile;
                                echo '</div>';
                            } elseif ((is_home() || is_archive()) && WOOCTheme::$options['blog_style'] == '3') {
                                while (have_posts()) : the_post();
