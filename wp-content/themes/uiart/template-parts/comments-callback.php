...
<div id="respond-<?php comment_ID(); ?>" class="each-comment">
	...
	<div class="comments-body">
		<div class="comment-meta">
			...
			<span>,</span>
			<div class="comment-time"><?php printf( esc_html__( '%s @ %3s', 'uiart'), $date, $time );?></div>
		</div>
		<div class="comment-text">
			<?php if ( '0' == $comment->comment_approved ) : ?>
				<p class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'uiart' ); ?></p>
			<?php endif; ?>
			<?php comment_text(); ?>							
		</div>
	</div>
