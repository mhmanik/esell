...
$previous_text = '<i class="fa fa-angle-left" aria-hidden="true"></i><em>' . esc_html__( 'Previous', 'uiart' ) . '</em>';
$next_text     = '<em>' . esc_html__( 'Next', 'uiart' ) . '</em><i class="fa fa-angle-right" aria-hidden="true"></i>';
