...
$wc_mobile_product_columns = WOOCTheme::$options['wc_mobile_product_columns'];
$wc_tab_product_columns = WOOCTheme::$options['wc_tab_product_columns'];

$product_col_class = (WOOCTheme::$layout == 'full-width') ? "col-xl-3 col-lg-3 col-md-{$wc_tab_product_columns} col-sm-{$wc_tab_product_columns} col-{$wc_mobile_product_columns}" : "col-xl-4 col-lg-4 col-md-{$wc_tab_product_columns} col-sm-{$wc_tab_product_columns} col-{$wc_mobile_product_columns}";
$product_class = '';
...
$block_data_defaults = array(
    'type' => $shopview,
    'layout' => WOOCTheme::$options['wc_product_layout'],
    'list_layout' => 1,
    'cat_display' => WOOCTheme::$options['wc_shop_cat'] ? true : false,
    'rating_display' => WOOCTheme::$options['wc_shop_review'] ? true : false,
    'v_swatch' => true,
);

$block_data_defaults['type'] = apply_filters('wooctheme_shop_view_type', $block_data_defaults['type']);
