...
if ( WOOCTheme::$options['shop_categories_layout'] == '1' ) {  
    $shop_categories_layout     = 'col-lg-12';
}elseif (WOOCTheme::$options['shop_categories_layout'] == '2' ) { 
     $shop_categories_layout     = 'col-lg-6';   
}elseif (WOOCTheme::$options['shop_categories_layout'] == '3' ) { 
    $shop_categories_layout     = 'col-lg-4';
}elseif (WOOCTheme::$options['shop_categories_layout'] == '6' ) {     
...
?>
    <div class="wooc-shop-header<?php echo esc_attr( $header_class ); ?>">
        <div class="wooc-shop-menu <?php echo esc_attr( WOOCTheme::$options['shop_categories_layout'] ); ?>">
                ...
                <div class="col-12">
                    <ul id="wooc-shop-filter-menu" class="wooc-shop-filter-menu">
                        ...
                        <li class="wooc-shop-categories-btn-wrap" data-panel="cat">
                            <a href="#categories" class="invert-color"><?php esc_html_e( 'Categories', 'uiart' ); ?></a>
                        </li>
                        <?php 
						endif;
						if ( $show_filters ) :
                        ...
                        <li data-panel="filter">
                            <a href="#filter" class="invert-color wooctheme-border-button"><?php esc_html_e( 'Filter', 'uiart' ); ?> <i class="flaticon-plus-symbol"></i></a>
						</li>                   

                        <li class="wooc-shop-search-btn-wrap" data-panel="search">                           
                            <a href="#search" id="wooc-shop-search-btn" class="invert-color wooctheme-border-button">
                                <i class="fas fa-search"></i> <span><?php esc_html_e( 'Search', 'uiart' ); ?></span>
        ...
        <div id="wooc-shop-sidebar" class="wooc-shop-sidebar wooc-shop-sidebar-header" data-sidebar-layout="header">
            <div class="wooc-shop-sidebar-inner">
                <div class="wooc-row">
                    <div class="col-xs-12">
                        <ul id="wooc-shop-widgets-ul" class="small-block-grid-<?php echo esc_attr( WOOCTheme::$options['shop_filters_columns'] ); ?>">
                            <?php
        ...
        <?php 
			// Search-form
			//if (  WOOCTheme::$options['shop_search'] ) {
