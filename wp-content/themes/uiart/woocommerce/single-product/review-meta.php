...
<div class="wc-review-meta">
	<div class="rtin-left">
		...
		<?php if ( $is_approved ): ?>
			...
			<?php if ( $is_verified ): ?>
				<div class="wc-review-verified"><?php esc_html_e( 'Verified Owner', 'uiart' );?></div>
			<?php endif; ?>
		<?php else: ?>
			<div class="wc-review-awaiting"><?php esc_html_e( 'Your review is awaiting approval', 'uiart' ); ?></div>
		<?php endif; ?>
	</div>
