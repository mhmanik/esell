...
$previous_text = '<i class="fa fa-angle-left" aria-hidden="true"></i><em>' . esc_html__( 'Previous', 'esell' ) . '</em>';
$next_text     = '<em>' . esc_html__( 'Next', 'esell' ) . '</em><i class="fa fa-angle-right" aria-hidden="true"></i>';
