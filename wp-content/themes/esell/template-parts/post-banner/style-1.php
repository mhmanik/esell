...
?>
<!-- Start Banner Area -->
<div class="banner banner-single-post post-layout-3 post-formate post-standard bg_image d-flex align-items-end" style="background-image: url(<?php the_post_thumbnail_url(); ?>)">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <!-- Start Single Slide  -->
