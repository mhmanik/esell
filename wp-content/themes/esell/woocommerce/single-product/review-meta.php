...
<div class="wc-review-meta">
	<div class="review-left">		
		<?php if ( $is_approved ): ?>
			...
			<?php if ( $is_verified ): ?>
				<div class="wc-review-verified"><?php esc_html_e( 'Verified Owner', 'esell' );?></div>
			<?php endif; ?>
		<?php else: ?>
			<div class="wc-review-awaiting"><?php esc_html_e( 'Your review is awaiting approval', 'esell' ); ?></div>
		<?php endif; ?>
